# Exporting core COREAXI4INTERCONNECT_0 to TCL
# Exporting Create design command for core COREAXI4INTERCONNECT_C0
create_and_configure_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:2.8.103} -component_name {COREAXI4INTERCONNECT_0} -params {\
"ADDR_WIDTH:32"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:64"  \
